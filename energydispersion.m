...
params_pK=mainTMD('Nmax',3,'m_b',1.2,'valley',1,'V_t',0,'psi_t',240,'V_b',15,'psi_b',-14,'vz_t',10,'vz_b',0,'w',20);
...
params_mK=mainTMD('Nmax',3,'m_b',1.2,'valley',-1,'V_t',0,'psi_t',240,'V_b',15,'psi_b',-14,'vz_t',10,'vz_b',0,'w',20);
