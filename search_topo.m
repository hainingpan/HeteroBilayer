vz_list=linspace(-80,50,51);
topo_pK_list=vz_list;
gap_list=vz_list;
% topo_mK_list=vz_list;
for vz_i=1:length(vz_list)
    vz=vz_list(vz_i);
    params_pK=mainTMD('Nmax',3,'valley',1,'V_t',4.1,'psi_t',240,'V_b',4.1,'psi_b',-14,'vz_t',vz,'vz_b',0,'w',8.3);
    % params_mK=mainTMD('Nmax',3,'valley',-1,'V_t',4.1,'psi_t',240,'V_b',4.1,'psi_b',-14,'vz_t',vz,'vz_b',0,'w',1.3);
