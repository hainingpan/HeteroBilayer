...
%         epoch=0;
    ...
    save(sprintf('phase_nu%d,%d_ep%d_w%.1f_Vb%.1f_d%d_Nk%d.mat',nu(1),nu(2),ep,w,Vb,d,Nk),'chern_p_list','chern_m_list','gap_final_list','tot_final_list','epoch_list','vz_t_list','s0_list','sx_list','sy_list','sz_list','rmap_x_list','rmap_y_list')
end
