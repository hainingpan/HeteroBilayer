...
params=mainTMD('SDW',10e-3,'d',5,'Nmax',Nmax,'V_t',0,'psi_t',240,'V_b',Vb,'psi_b',-14,'vz_t',vz,'vz_b',0,'w',w,'nu',nu,'n',15,'epsilon',ep,'shift',1);
...
re=plotline_2(energyall,0,0,V1_ave_delta,V2_ave_delta,ave1,ave2,0,strcat('fsd',params.chern),params);
gap=re.gap;
tot=re.tot;
% fig1=re.fig1;
% fig2=re.fig2;
...
for i=1:100
    ...
    re=plotline_2(energyall,ave1,ave2,V1_ave_delta,V2_ave_delta,ave1_n,ave2_n,i,strcat('fsd',params.chern),params);
    gap=re.gap;
    tot=re.tot;
    gap_list(end+1)=gap;
    tot_list(end+1)=tot;
