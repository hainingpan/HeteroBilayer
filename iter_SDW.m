...
[gap,tot,fig1,fig2]=plotline_2(energyall,0,0,V1_ave_delta,V2_ave_delta,ave1,ave2,0,'fs',params);
...
for i=1:100
    ...
    [gap,tot]=plotline_2(energyall,ave1,ave2,V1_ave_delta,V2_ave_delta,ave1_n,ave2_n,i,'fs',params);
    gap_list(end+1)=gap;
    tot_list(end+1)=tot;
    figure(fig1);
