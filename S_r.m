function [s0,sx,sy,sz]=S_r(ave2,rmap_x,rmap_y,l,params)
    ...
    size_ave2=size(ave2);
    size_ave2([1,4,8])=[];
    ave2=reshape(sum(ave2(:,:,:,l,:,:,:,l,:),1),size_ave2);  % q_d,b_d,t_a,q_g,b_g,t_b
    ...
    s0=ttt2(sigma0,expm_ave2,[1,2],[2,3],[],[])/(Nk*Nq);
    sx=ttt2(sigmax,expm_ave2,[1,2],[2,3],[],[])/(Nk*Nq);
    sy=ttt2(sigmay,expm_ave2,[1,2],[2,3],[],[])/(Nk*Nq);
    sz=ttt2(sigmaz,expm_ave2,[1,2],[2,3],[],[])/(Nk*Nq);
