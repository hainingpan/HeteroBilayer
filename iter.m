...
params=mainTMD('Nmax',2,'V_t',0,'psi_t',240,'V_b',15,'psi_b',-14,'vz_t',-4,'vz_b',0,'w',20,'nu',[1,1],'n',15,'epsilon',25);
...
[gap,tot]=plotline_2(energyall,wfall,occ,valley_index,0,0,V1_ave_delta,V2_ave_delta,ave1,ave2,params);
...
for i=1:100
    ...
    [gap,tot]=plotline_2(energyall,wfall,occ,valley_index,ave1,ave2,V1_ave_delta,V2_ave_delta,ave1_n,ave2_n,params);
    gap_list(end+1)=gap;
    tot_list(end+1)=tot;
    figure(fig1);
    plot(tot_list*1e3);
